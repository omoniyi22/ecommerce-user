                    ...
                    <div className="relative mx-auto sm:static px-6 lg:px-8">
                        <div className="max-w-xl text-start">
                            <h1 className="text-3xl md:text-4xl max-md:mb-6 font-bold tracking-tight text-primary">
                                <span className="text-accent">50%</span> Off
                            </h1>
                            ...
                            <div className="flex gap-4 mt-10 items-content max-sm:justify-center max-sm:mt-6">
                                <button type="button" class="rounded-lg border border-primary bg-primary 
                                px-5 py-2.5 text-center text-md font-medium text-white shadow-sm transition-all
                                 hover:border-secondary hover:bg-secondary focus:ring focus:ring-primary-200 
                                disabled:cursor-not-allowed disabled:border-primary-300 disabled:bg-primary-300"
                                    onClick={addItemToCart}
                                >Add to Cart</button>


                                <Link href="/products" class="rounded-lg border border-gray-300 bg-white px-5 py-2.5 
                            ...
                            <div className="hidden lg:block absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                                <div className="flex items-center space-x-6 lg:space-x-8">
                                    <div className="grid flex-shrink-0 grid-cols-1 grid-y-12 ">
                                    ...
                                    <div className="grid flex-shrink-0 grid-cols-1 grid-y-12 mt-3">
