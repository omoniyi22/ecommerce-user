...
export default function Header() {
    ...
    return (
        <header className="bg-white border-b border-primary border-opacity-30 z-40
        sticky top-0
        " >
            {/* px-4 sm:px-6 lg:px-8 */}
            <div className="mx-auto flex h-16 max-w-screen-2xl items-center gap-8 px-4 sm:px-6 lg:px-8 text-xl ">
                <Link className=" text-primary flex item-center gap-1" href="/">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="sm:flex sm:gap-4 items-center">
                            {session ?
                                ...
                                :
                                (<Link
                                    className="text-sm font-medium px-4 py-1 text-center transition border-r border-primary"
                                    href="/"
                                >
                                    Account
                                </Link>)
                            ...
                            <Link
                                className="rounded-md text-sm flex items-center font-medium transition group p-2 "
                                href="/cart"
                            >
