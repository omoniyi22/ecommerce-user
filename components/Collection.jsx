                                ...
                                <div className="grid p-6 bg-gray-100 rounded place-content-center sm:p-8">
                                    <div className="max-w-md mx-auto text-center lg:text-left">
                                        <header>
                                            ...
                                            <p className="mt-1 text-lg text-primary mb-10">
                                                N {formatPrice(product.price) }
                                            </p>
                                        </header>
                                        <Link href="/products" class="rounded-lg border border-gray-300 bg-white px-12 py-3 
                                text-center text-md font-medium text-gray-700 shadow-sm transition-all 
                                hover:bg-gray-100 focus:ring focus:ring-gray-100 hover:border-secondary">Shop All</Link>
                                    </div>
                                </div>
