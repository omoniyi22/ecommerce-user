                ...
                <section className="mt-20 md:mt-6">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="p-4 lg:p-8 border">
                            ...
                            {/* product details */}
                            {/* <div className="mt-6">
                                <h2 className="text-lx font-semibold">
                                    Details
                                </h2>
                                <p className="mt-2 text-gray-700">
                                    {product.details}
                            ...
                            <div class="text-center w-full mt-6">
                                <button onClick={() => { addProduct(product._id); toast.success("Item added to cart") }}
                                    className="block rounded bg-secondary px-5 py-4 text-md text-text transition hover:bg-purple-300 w-full">Add to cart</button>
                            </div>
                        </div>
                    </div>
                </section>
